...
public class JDBC {
    private static String jdbcUrl = "jdbc:mysql://localhost:3306/quiz_gui_db";
    private static String username = "root";
    private static String password = "_RkshvJain123";

    public static boolean insertQuestionToDB(String question, String category,
